          ...
          <FadeIn delay={100}>
            <div className="space-y-5 text-gray-600 dark:text-gray-300 leading-relaxed text-base">
              ...
              <p>
                ...
                <span className="font-semibold text-gray-900 dark:text-white">40% reduction in network outages</span>.
              </p>
              <p>
                I&apos;m based in{' '}
                <span className="font-semibold text-gray-900 dark:text-white">New York City</span> and actively
          ...
          <FadeIn delay={200}>
            <div className="grid grid-cols-2 gap-4">
              {stats.map(({ icon: Icon, label, sub, color, bg }) => (
                <div
                  key={label}
                  className="bg-white dark:bg-gray-700 rounded-2xl p-5 border border-gray-100 dark:border-gray-600 shadow-sm hover:shadow-md transition-shadow hover:-translate-y-0.5 transition-transform"
                >
