...
export default function Extracurriculars() {
  return (
    <section id="activities" className="bg-gray-50 dark:bg-gray-800 py-20">
            ...
            <FadeIn key={group.institution} delay={gi * 80}>
              <div>
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h3 className="text-base font-bold text-gray-900 dark:text-white">{group.institution}</h3>
                  <span
                ...
                <div className="grid sm:grid-cols-2 gap-4 pl-6">
                  {group.activities.map((activity, ai) => (
                    <FadeIn key={activity.name} delay={gi * 80 + ai * 50}>
                      <div className="bg-white dark:bg-gray-700 rounded-2xl border border-gray-100 dark:border-gray-600 shadow-sm p-5 hover:shadow-md dark:hover:shadow-gray-900/40 transition-all duration-300 hover:-translate-y-0.5 flex flex-col h-full">
                        {/* Icon + Name + Role */}
                        ...
                        {/* Highlight metric */}
                        <div className="bg-gray-50 dark:bg-gray-600 rounded-xl px-3 py-2 border border-gray-100 dark:border-gray-500">
